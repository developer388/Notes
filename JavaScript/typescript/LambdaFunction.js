...
var MyLibrary = function (filename) {
...
var compressFile = function (filename) { return __awaiter(void 0, void 0, void 0, function () {
    var lib;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                console.log('compressFile called');
                return [4 /*yield*/, MyLibrary(filename)];
            case 1:
                lib = _a.sent();
                return [2 /*return*/, lib];
        }
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                promiseList = event.body.files.map(function (filename) {
